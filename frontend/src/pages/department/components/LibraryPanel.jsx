  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const pendingRes = await axios.get(
        "https://your-dues.onrender.com/api/department/library",
        { headers: { Authorization: `Bearer ${token}` } },
      );

      // const statsRes = await axios.get(
      //   "https://your-dues.onrender.com/api/department/library/stats/today",
      //   { headers: { Authorization: `Bearer ${token}` } }
      // );
  ...
  const fetchHistory = async () => {
    ...
    try {
      const res = await axios.get(
        "https://your-dues.onrender.com/api/department/library/history",
        { headers: { Authorization: `Bearer ${token}` } },
      );
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-blue-100 mt-1">
                      Library Clearance Verification
                    </p>
                  </div>
                  <button
                    onClick={resetModal}
