...
console.log("STEP 2 RESPONSE:", res2.data);
  ...
  const calculatePendingFees = (app) => {
    const totalFees = app.totalFees || 0;
    const paidFees = app.paidFees || 0;
    const fine = app.fine || 0;
    return totalFees - paidFees + fine;
  };
