...
export default function TPDashboard() {
  ...
  const [noDocumentsPending, setNoDocumentsPending] = useState(false);
  ...
  const resetModal = () => {
    setSelectedApp(null);
    setPlacementDuesCleared(false);
    setTrainingBondCompleted(false);
    setNoDocumentsPending(false);
    setRemark("");
  };
        ...
        <div className="p-4 border-t border-blue-700">
          <div className="flex items-center mb-4 px-2">
            ...
            <div className="ml-3 flex-1">
              <p className="text-sm font-medium">T&P Officer</p>
